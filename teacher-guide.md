...
- (2) Install/Verify: ran hello-world
- (2) Build/Run: built image and mapped port
- (2) Volumes: demonstrated bind mount
- (2) Env: changed app behavior via env var
- (2) Hygiene/Push: logs+cleanup and optional push
